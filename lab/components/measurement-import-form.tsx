...
// Simple version to ensure it renders
export default function MeasurementImportForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    toast.success("This is a demo - measurement would be created here")
    router.push("/measurements")
  }
      ...
      <CardContent>
        <form onSubmit={handleSubmit}>
          <div className="space-y-6">
            ...
            {/* Entry Method Tabs */}
            <Tabs value={entryMethod} onValueChange={(v) => setEntryMethod(v as "import" | "manual")} className="mt-6">
